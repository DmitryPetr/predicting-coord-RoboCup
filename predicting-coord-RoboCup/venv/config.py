...
actionInfoTick = ['time', 'action', 'sideWithBall', 'lenOfNearest', 'nearestPlayer', 'lenOfMiddleDist', 'middleDistPlayer', 'passPair', 'goalIsNearest']
...
pathDefault = '/mnt/c/qualityWorkMasters/predicting-coord-RoboCup/example_csv/save-example/'#
...
#refixFiles = '20170905232453-Oxsy_2-vs-HfutEngine2017_2-'
#numberTeamGoalie = [7, 1] # Oxsy_2-vs-HfutEngine2017_2
